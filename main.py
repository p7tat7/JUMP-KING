...
def main():
    ...
    # Create Character
    king_player = king.MainCharacter(500, 875, setting.character_size, setting.jumping_height, setting.walking_speed)

    # Create Environment
    backdrop = pygame.image.load(os.path.join(setting.stage_images_path, "1.png"))
